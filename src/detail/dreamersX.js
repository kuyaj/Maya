...
class DreamersX extends Component {
...
return (
     <Modal size="tiny" trigger={  
      ...
      <Modal.Header> Jennifer Adams </Modal.Header>
        <Modal.Content image>
    
                <Image wrapped size="big" src={ dreamers }/>
             <Modal.Description>
                 <Header>The Dreamers </Header>
